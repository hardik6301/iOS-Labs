...
//print("The value of foo is \(foo)")
// Because foo is defined in for loop and is a local variable.
...
// x is defined in global scope and modified in local scope in for loop. But, foo was defined and modified in local scope.
...
greeting(greeting: "Hii there", name: "Thomas")
greeting(greeting: nil, name: "Aurthur")
...
var myCar = Car(make: "Toyota", model: "Camry", year: 2020)
