...
var rect1 = Rectangle(width: 5, height: 5)
...
struct Height {
    var heightInInches: Double {
        didSet{
            let calculatedCentimetere = heightInInches * 2.54
            if heightInCentimeters != calculatedCentimetere{
                heightInInches = calculatedCentimetere
            }
        }
    }
...
var person = Height(heightInInches: 60)
print(person.heightInCentimeters)
