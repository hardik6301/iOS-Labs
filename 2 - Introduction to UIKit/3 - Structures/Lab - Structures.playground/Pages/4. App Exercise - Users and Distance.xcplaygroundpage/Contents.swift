...
var Hardik = User(name: "Hardik", age: 20, height: 188, weight: 60, activityLevel: 7)
print(Hardik.name, Hardik.age, Hardik.height, Hardik.weight, Hardik.activityLevel)
/*:
...
var mile2 = Distance(feet: 32808.4)
print(mile2.meters)
