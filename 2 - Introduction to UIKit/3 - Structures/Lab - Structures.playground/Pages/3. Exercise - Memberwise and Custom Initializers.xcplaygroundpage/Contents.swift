...
var favouriteBook = Book(title: "The Alchemist", author: "Paulo Coelho", pages: 222, price: 12.99)
print("My favorite book is \(favouriteBook.title) by \(favouriteBook.author) has pages \(favouriteBook.pages) and costs $\(favouriteBook.price)")
...
let Lapop1 = Laptop(yearPurchased: 2019)
let Lapop2 = Laptop(screenSize: 15, yearPurchased: 2020)
